...
python python/converter.py --model examples/zkml_tflite/mobilenet.tflite --model_output examples/cifar/mobilenet.msgpack --config_output examples/cifar/mobilenet_config.msgpack --scale_factor 512 --k 19 --num_cols 10 --num_randoms 1024
...
python python/converter.py --model examples/zkml_tflite/mobilenet.tflite --model_output examples/cifar/mobilenet_p.msgpack --config_output examples/cifar/mobilenet_p_config.msgpack --scale_factor 512 --k 19 --num_cols 10 --num_randoms 1024 --commit
