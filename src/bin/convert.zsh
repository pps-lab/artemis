...
python python/converter.py --model examples/zkml_tflite/diffusion.tflite --model_output examples/zkml_tflite/diffusion.msgpack --config_output examples/cifar/diffusion_config.msgpack --scale_factor 512 --k 19 --num_cols 10 --num_randoms 1024
...
#python python/fake_input_converter.py --model_config examples/cifar/medium_model_nocom.msgpack --output examples/cifar/input.msgpack 
