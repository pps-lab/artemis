...
use halo2_proofs::{dev::MockProver, halo2curves::bn256::{Fr, G1Affine}};
use zkml::{
  model::ModelCircuit,
  utils::{
...
fn main() {
  ...
  let k = config.k;
  let circuit = ModelCircuit::<G1Affine>::generate_from_msgpack(config, false, false, 0, 17, 10, false, false);
