...
wait
./target/release/time_circuit examples/twitter/config.msgpack examples/twitter/inp1.msgpack kzg true 0 24 10 halo2pngs/twitter_kzg.png > halo2logs/twitter_kzg.txt &
wait
