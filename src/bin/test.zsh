...
wait
./target/release/time_circuit examples/cifar/vgg.msgpack examples/cifar/vgg_input.msgpack kzg false 2 24 10 halo2pngs/vgg_poly_kzg.png > halo2logs/vgg_poly_kzg.txt &
wait
...
# wait
./target/release/time_circuit examples/nlp/gpt-2/model.msgpack examples/nlp/gpt-2/inp.msgpack kzg false 2 27 5 halo2pngs/gpt2_poly_kzg.png > halo2logs/gpt2_poly_kzg.txt &
wait

# ./target/release/time_circuit examples/cifar/diffusion.msgpack examples/cifar/diffusion_input.msgpack kzg false 2 25 13 halo2pngs/diffusion_kzg.png > halo2logs/diffusion_kzg.txt &
# wait
./target/release/time_circuit examples/nlp/gpt-2/model.msgpack examples/nlp/gpt-2/inp.msgpack kzg true 0 27 5 halo2pngs/gpt2_kzg.png > halo2logs/gpt2_kzg.txt &
wait
...
# wait
cargo run --package zkml --bin cp_link --release 24 15000000 10  > 15000000_10.log &
wait
cargo run --package zkml --bin cp_link --release 27 80000000 5  > 80000000_5.log &
wait
