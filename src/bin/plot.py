...
names = ['mnist', 'snet', 'dlrm', 'vgg', 'gpt2']
commitments = ['nocom', 'poly', 'pos']
modelsizes = ['~10k', '~100k', '~750k', '~15m', '~81m']
...
cplink_overhead = [1.1, 6.1, 45.6, 691.4]
...
plt.xticks(x + 0.3 / 2, names)


# Add titles and labels
plt.title('Prover times')
plt.xlabel('Models')
plt.xticks(x + bar_width, names_sizes)
