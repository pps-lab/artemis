...
This repository contains the implementation of Artemis CP-SNARK construction.
...
```sh
aws s3 sync s3://artemis-artifact/models examples/models
```
...
| Suite                                                                               | Models                                                           |
|-------------------------------------------------------------------------------------|------------------------------------------------------------------|
| [model-small](doe-suite-config/designs/model-small.yml)                             | mnist, resnet18, dlrm                                            |
| [model-mobilenet](doe-suite-config/designs/mobilenet.yml)                           | MobileNet                                                        |
| [model-vgg](doe-suite-config/designs/vgg.yml)                                       | VGG                                                              |
| [model-diffusion](doe-suite-config/designs/diffusion.yml)                           | Diffusion                                                        |
| [model-gpt2](doe-suite-config/designs/model-gpt2.yml)                               | GPT-2                                                            |
