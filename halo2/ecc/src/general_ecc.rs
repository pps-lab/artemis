...
mod tests {
    ...
    use integer::halo2::halo2curves::group::prime::PrimeCurve;
    ...
    fn test_general_ecc_mul_circuit() {
        ...
        >() {
            ...
            let circuit: TestEccMul<C, N, NUMBER_OF_LIMBS, BIT_LEN_LIMB> = TestEccMul::<C, N, NUMBER_OF_LIMBS, BIT_LEN_LIMB> {
                aux_generator,
                window_size: 1,
                ..Default::default()
            };
    ...
    #[test]
    fn test () {
        test_generic::<Bn256, BnScalar>();
        // test_generic::<Pallas, PastaFq>();
        // test_generic::<Pallas, PastaFp>();
    }
    fn test_generic<C: CurveAffine, N: FromUniformBytes<64> + Ord> () {
        let aux_generator = <C as PrimeCurveAffine>::Curve::random(OsRng).to_affine();
